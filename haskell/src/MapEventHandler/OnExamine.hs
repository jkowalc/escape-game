...
examine :: Place -> IO ()
examine MainRoom = do putStrLn "Hmmmm... Whoever lived here must have left long ago... \
\I feel a cool breeze coming from a vent located under the celing."
examine Desk = do putStrLn "There are few drawers under the desk. I can try to open them."
--     spawn_subplace(desk, top_drawer), / TODO
--     spawn_subplace(desk, mid_drawer),
--     spawn_subplace(desk, bottom_drawer),nl,!.
-- examine BottomDrawer = do putStrLn "There is a small bite of cheese. It won't fill my stomach but may come in handy later."
-- --     spawn_item(cheese, desk)"
-- examine TopDrawer = do putStrLn "There is a small key. It might fit to something I have right now."
-- --     spawn_item(small_key, desk),nl,!.
examine Fireplace = do putStrLn "Fire place wasnt used in a long time but thera are still some chared but sturdy pices of wood.\
\LONG STICK always can come in handy."
--     spawn_item(long_stick, fireplace).
examine Painting = do putStrLn "It's very damaged. Oh! The TORN CORNER of the painting is peeling back from the frame!"
--     spawn_subplace(painting, torn_corner),nl.
examine TornCorner = do putStrLn "After pulling the canvas back I realised that there is a message scratched into painting backing.\
\It says:\"I have 4 legs, two heads, huge slender body and little friend.\""
examine HeavyDoor = do putStrLn "Big heavy door closed shut.\
\Nail marks and scratches don't make me feel good about it..."
examine Chair = do putStrLn "Mud smeared on top looks like a foot print... Why someone was standing on top of it?\
\Oh! I can move it underneeth the vent I've seen before." 
--     spawn_subplace(chair, vent_cover).
examine WoodenBox = do putStrLn "This wooden box looks pretty rough, although it might be impossible to open it by force. But there is some kind of mechanism"
examine Bed = do putStrLn "There's a bed with disgustingly YELLOW legs. Your eyes are pulled to two CRIMSON blood-like pillows.\
\ owever quilt seems to be quite different, it calms you down and reminds of life outside"

--Office
examine Office = do putStrLn "Man this place is devastated. Walls with holes punched into them, blinds ripped off the window.\
\I can see an trapdoor under the ceeling. I can't reach it..."



examine _ = do putStrLn "I can't examine it"  -- Default case when none of the patterns match
